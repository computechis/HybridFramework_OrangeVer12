package com.computechis.utilites;
...
public class Utility {
	...
	public static String getScreenshot(WebDriver driver) {
		String path = System.getProperty("user.dir")+"\\Screenshots\\OragangHRM_"+getCurrentTime()+".png";
	...
	public static void verifyAlertText(WebDriver driver, String exp_alert_text) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		String act_alert_text=wait.until(ExpectedConditions.alertIsPresent()).getText();
		Assert.assertEquals(act_alert_text, exp_alert_text);
	}

	public static void verifyTitle(WebDriver driver, String exp_title) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		Assert.assertTrue(wait.until(ExpectedConditions.titleIs(exp_title)));
	}
